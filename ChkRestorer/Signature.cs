...
namespace ChkRestorer
{
    ...
    {
        internal static readonly Dictionary<byte[], string> SignatureExtensions = new Dictionary<byte[], string>(new ByteArrayComparer())
        {
            ...
            { new byte[] { 0x00, 0x00, 0x49, 0x49 }, ".qxd" },
            ...
            { new byte[] { 0x00, 0x00, 0x00, 0x18, 0x66, 0x74, 0x79, 0x70, 0x68, 0x65, 0x69, 0x63 }, ".heic" },
            { new byte[] { 0x1F, 0x8B }, ".z" },
            { new byte[] { 0x1F, 0xA0 }, ".lzh" },
            ...
            { new byte[] { 0x25, 0x21, 0x50, 0x53, 0x2D, 0x41, 0x64, 0x6F, 0x62, 0x65, 0x2D, 0x33, 0x2E }, ".epsf" },
            ...
            { new byte[] { 0x3C, 0x3F, 0x78, 0x6D, 0x6C }, ".svg" },
            { new byte[] { 0x43, 0x44, 0x30, 0x30, 0x31 }, ".iso" },
            { new byte[] { 0x43, 0x44, 0x49, 0x30, 0x31 }, ".cdi" },
            ...
            { new byte[] { 0x05, 0x07, 0x00, 0x00, 0x42, 0x4F, 0x42, 0x4F }, ".cwk" },
            ...
            { new byte[] { 0x75, 0x73, 0x74, 0x61 }, ".tar" },
            ...
            { new byte[] { 0x50, 0x34 }, ".pbm" },
            { new byte[] { 0x50, 0x35 }, ".pgm" },
            { new byte[] { 0x50, 0x36 }, ".ppm" },
            ...
            { new byte[] { 0x3C, 0x3C, 0x3C, 0x20 }, ".vdi" },
            ...
            { new byte[] { 0x00, 0x01, 0x00, 0x00, 0x53, 0x74, 0x61, 0x6E, 0x64, 0x61, 0x72, 0x64, 0x20 }, ".accdb" },
            { new byte[] { 0x01, 0xFF, 0x02, 0x04, 0x03 }, ".drw" },
            { new byte[] { 0x00, 0x64, 0x73, 0x73 }, ".dss" },
            ...
            { new byte[] { 0x00, 0x53, 0x48, 0x7C }, ".hl7" },
            { new byte[] { 0x70, 0x77, 0x72, 0x64, 0x61, 0x74, 0x61 }, ".pwrdata" },
            { new byte[] { 0x1A, 0x02 }, ".arc" },
